 ...
 * Ví dụ: https://www.nav3recipes.com/users/search?firstName={firstName}&ageMin={ageMin}&ageMax={ageMax}&location={location}
 * https://www.nav3recipes.com/users/home
 * https://www.nav3recipes.com/users/include/{filter}
 */
...
// Exact URL matching "https://www.nav3recipes.com/home"
internal const val URL_HOME_EXACT = "$PATH_BASE/$STRING_LITERAL_HOME"

// URL with path argument "https://www.nav3recipes.com/users/with/{filter}"
internal const val URL_USERS_WITH_FILTER = "$PATH_BASE/$PATH_INCLUDE/{$STRING_LITERAL_FILTER}"

// URL with query parameters "https://www.nav3recipes.com/users/search?{firstName}&{age}&{location}"
