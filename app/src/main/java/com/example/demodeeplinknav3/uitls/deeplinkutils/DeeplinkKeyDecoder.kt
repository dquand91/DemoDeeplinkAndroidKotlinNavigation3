...
/**
 * Vì sau khi parse deeplink, nó sẽ cho ra 1 Map <String, Any> với String là tên tham số, Any là giá trị tham số (thuộc Serializable primitive types).
 * Nên cái DeeplinkKeyDecoder này sẽ dùng để decode cái Map <String, Any> đó thành 1 backstack key (NavKey) tương ứng.
 *
 * *Quan Trọng* Cái Decoder này chỉ hoạt động khi tất cả các kiểu tham số là Kiểu Nguyên Thủy (Primitives).
 */
@OptIn(ExperimentalSerializationApi::class)
internal class DeeplinkKeyDecoder(
